                    ...
                    <form method="POST" action="{{ route('bidan.update', $data->id) }}">
                      ...
                      <div class="card-body">
                        <div class="form-group">
                          ...
                          <input type="nama_bidan" name="nama_bidan" value="{{ $data->nama_bidan }}" class="form-control" id="nama_bidan" placeholder="Masukkan nama">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input type="no_str" name="no_str" value="{{ $data->no_str }}" class="form-control" id="no_str" placeholder="No. STR">
                        </div>
                        <div class="form-group">
