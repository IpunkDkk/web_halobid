                ...
                <div class="flex items-center px-4">
                    ...
                    <nav id="nav-menu" class="hidden absolute py-5 bg-white shadow-lg rounded-lg max-w-[250px] w-full right-4 top-full lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none">
                        <ul class="block lg:flex">
                            ...
                            <li class="group">
                                <a href="#" class="text-base font-bold text-dark py-2 mx-8 flex group-hover:text-primary">Login</a>
                            </li>
                        </ul>
                    </nav>
    ...
    <footer class="bg-dark pt-24 pb-12">
        <div class="container">
            ...
            <div class="w-full pt-10 border-t border-slate-700">
                ...
                <p class="font-medium text-xs text-slate-500 text-center">Copyright <a href="https://instagram.com/taufiqurrm_" target="_blank" class="font-bold text-primary">HaloBid</a></p>
            </div>
        </div>
    </footer>
    <!-- Footer End -->
