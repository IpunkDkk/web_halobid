                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Edit Data Ibu KB</h3>
                        </div>
                        <form method="POST" action="{{ route('kb.update', $data->id) }}">
                            @method('PATCH')
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                  <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="pekerjaan" class="form-control" id="pekerjaan" placeholder="Pekerjaan" value="{{ $data->pekerjaan }}">
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <div class="input-group">
                                        ...
                                        <input type="text" name="no_hp" id="no_hp" class="form-control" placeholder="+62" value="{{ $data->no_hp }}">
                                      </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="number" name="jml_anak" class="form-control" id="jml_anak" placeholder="Jumlah Anak" value="{{ $data->jml_anak }}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <textarea class="form-control" rows="3" name="ket_pemeriksaan" id="ket_pemeriksaan" placeholder="......">{{ $data->ket_pemeriksaan }}</textarea>
                                    </div>
                                  </div>
                                </div>
                              </div>
