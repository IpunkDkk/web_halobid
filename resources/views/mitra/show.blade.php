                ...
                <div class="col-md-12">
                  ...
                  <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Profil Mitra</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                      ...
                      <div class="card-body">
                        <div class="form-group">
                          ...
                          <input type="nama_mitra" name="nama_mitra" value="{{ $data->nama_mitra }}" class="form-control" id="nama_mitra" placeholder="Masukkan nama" disabled>
                        </div>
                        <div class="form-group">
